...
Screenshot classifier - to assist with cleaning up lots of untitled / unlabelled screenshots which tend to accumulate over time

Project for the https://fast.ai course to classify screenshots using computer vision techniques.

----

### Appendix: `nbdev` template
